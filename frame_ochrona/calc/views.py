...
USERS = {
    "pracownik": {"password": "pracownik123", "min_interest": 5.0},
    "menager": {"password": "menager123", "min_interest": 1.0},
}
...
def login_view(request):
    if request.session.get("role") in USERS:
...
def loan_calculator(request):
    ...
    min_interest = USERS[role]["min_interest"]
